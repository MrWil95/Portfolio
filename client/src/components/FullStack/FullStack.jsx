      ...
      <div className={open ? 'Paper' : 'PaperScale'}>
        ...
        <div className='projects'>
          ...
          >
            ...
            <p className={sound? null : 'fade'}><span>Description:</span> Sound is a marketplace sort of like Etsy where musicians can sell their audio equipment at a far price. Built with React and Express, just signup and signin with a secure password hased using JWT and Bcrypt to keep everyone safer. A team full of talented engineers came together and deployed </p>
          </a>
          <div className='tools'>
            <p>Made With:</p>
            <p>EXPRESS JS</p>
        ...
        <div className='projects'>
          ...
          <div className='tools'>
            <p>Made With:</p>
            <p>REACT JS</p>
            <p>ASYNCHRONOUS FUNCTIONALITY</p>
